...
function prefillTLabel(){
  // labels públicos traen 'label' pero aquí usamos el campo manual local (no lo tenemos aún); lo dejamos en blanco hasta que consultemos
  // (opcional: podríamos pedir /api/users/public/labels y leer label del transporte seleccionado)
}
